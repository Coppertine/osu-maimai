...
{
    public class SentakkiModRelax : ModRelax, IUpdatableByPlayfield, IApplicableToDrawableRuleset<SentakkiHitObject>
    {
        ...
        private SentakkiInputManager osuInputManager;
        ...
        public void ApplyToDrawableRuleset(DrawableRuleset<SentakkiHitObject> drawableRuleset)
        {
            ...
            osuInputManager = (SentakkiInputManager)drawableRuleset.KeyBindingInputManager;
